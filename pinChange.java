...
public class pinChange extends JFrame implements ActionListener{
    ...
    JButton change,back;
    String pinchange,passwordString;
    ...
    pinChange(String pinchange){
        ...
        JLabel text = new JLabel("Change of PIN");
        text.setForeground(Color.WHITE);
        text.setFont(new Font("System",Font.BOLD,16));
        text.setBounds(270,260,500,50);
        image.add(text);
        ...
        repin.setBounds(370,360,120,25);
        image.add(repin);
